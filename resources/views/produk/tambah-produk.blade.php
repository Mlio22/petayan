        ...
        @csrf
            ...
            <div class="col4">
                ...
                <span class="produk-form-title">
                    ...
                    <div class="col1">
                    <input name="nama_produk" class="form-control0" type="text" placeholder=" " aria-label="default input example">
                    </div>
            </div>
            <div class="col1">
                <span class="produk-form-title">
                    ...
                    <div class="col1">
                    <input name="harga_produk" class="form-control0" type="text" placeholder=" harga per kg " aria-label="default input example">
                    </div>
            </div>
            <div class="col1">
                <span class="produk-form-title">
                    ...
                    <div class="col1">
                    <input name="waktu_kadaluarsa" class="form-control0" type="text" placeholder=" contoh : 9 Hari" aria-label="default input example">
                    </div>
            </div>
            <div class="col1">
                <span class="produk-form-title">
                    ...
                    <div class="col1">
                    <input name="kategori_produk" class="form-control0" type="text" placeholder=" " aria-label="default input example">
                    </div>
            </div>
            <div class="col1">
                <span class="produk-form-title">
                ...
                <a href="#">
                    <button class="btn btn3"type="submit">Tambah Produk</button>
                </a>
                </div>
                </div>
                </div>
